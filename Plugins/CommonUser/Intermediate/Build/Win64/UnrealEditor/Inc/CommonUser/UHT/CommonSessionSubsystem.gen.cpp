...
void FCommonSessionOnCreateSessionComplete_Dynamic_DelegateWrapper(const FMulticastScriptDelegate& CommonSessionOnCreateSessionComplete_Dynamic, FOnlineResultInformation const& Result)
{
	...
	struct Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_2485123592(TEXT("/Script/CommonUser"),
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonSessionSubsystem_h_Statics::EnumInfo));
