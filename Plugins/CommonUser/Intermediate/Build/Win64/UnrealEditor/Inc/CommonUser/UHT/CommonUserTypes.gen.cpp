...
template<> COMMONUSER_API UScriptStruct* StaticStruct<FOnlineResultInformation>()
{
	...
	struct Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_2662987123(TEXT("/Script/CommonUser"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonUser_Source_CommonUser_Public_CommonUserTypes_h_Statics::EnumInfo));
