...
void FCommonMessagingResultMCDelegate_DelegateWrapper(const FMulticastScriptDelegate& CommonMessagingResultMCDelegate, ECommonMessagingResult Result)
{
	...
	struct Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_ShowConfirmation_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_ShowConfirmation_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_ShowConfirmation_h_4226858424(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_ShowConfirmation_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_ShowConfirmation_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
