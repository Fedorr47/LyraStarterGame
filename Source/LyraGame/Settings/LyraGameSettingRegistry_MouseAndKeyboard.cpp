...
UGameSettingCollection* ULyraGameSettingRegistry::InitializeMouseAndKeyboardSettings(ULyraLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		{
			UGameSettingValueDiscreteDynamic_Bool* Setting = NewObject<UGameSettingValueDiscreteDynamic_Bool>();
			Setting->SetDevName(TEXT("ToggleSprintAction"));
			Setting->SetDisplayName(LOCTEXT("ToggleSprintAction_Name", "Toggle Sprint Action"));
			Setting->SetDescriptionRichText(LOCTEXT("ToggleSprintAction_Description", "Toggle sprint action."));
