...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Lyra|Character", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<ULyraMovementComponent> AbilityMovementComponent;
...
#pragma region SHARED_SETTINGS_ACCESS
	ULyraSettingsShared* GetLyraSettingsShared() const;

	UFUNCTION(BlueprintPure, Category = "Lyra|Settings")
	bool GetToggleSprint() const;

private:
	UPROPERTY()
	ULyraSettingsShared* mSettingsShared = nullptr;
#pragma endregion
};
