	...
	: Super(ObjectInitializer.SetDefaultSubobjectClass<ULyraCharacterMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	...
	AbilityMovementComponent = CreateDefaultSubobject<ULyraMovementComponent>(TEXT("MovementComponent"));
...
//@TODO: SignificanceManager->RegisterObject(this, (EFortSignificanceType)SignificanceType);
	...
	mSettingsShared = GetLyraSettingsShared();
}
...
void ALyraCharacter::OnAbilitySystemInitialized()
{
	...
	AbilityMovementComponent->InitializeWithAbilitySystem(LyraASC);
...
void ALyraCharacter::OnAbilitySystemUninitialized()
{
	...
	AbilityMovementComponent->UninitializeFromAbilitySystem();
}
...
{
	if (mSettingsShared == nullptr)
	{
		return GetLyraSettingsShared()->GetToggleSprint();
	}
	else
	{
		return mSettingsShared->GetToggleSprint();
	}
	return false;
}
